...
import static test.factactor.benchmark.FastActorPingPongBenchmark.EXPECTED_DELIVERIES_COUNT;
...
import test.factactor.benchmark.FastActorPingPongBenchmark.DeliveryCounter;
